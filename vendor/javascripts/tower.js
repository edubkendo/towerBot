 ...
 */
(function() {
  var Tower, action, coffeescriptMixin, key, module, nativeIndexOf, phase, specialProperties, towerMixin, _, _fn, _fn1, _fn2, _fn3, _fn4, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  Tower.modules = {
    ...
    async: global.async,
    coffeecup: global.CoffeeCup ? global.CoffeeCup : global.CoffeeKup,
    socketio: (function() {
      try {
        return global.io;
      } catch (_error) {}
  ...
  _.extend(Tower, {
    ...
    getCursor: function(path) {
      if (Tower.isClient) {
        ...
        return Ember.getPath(Tower.cursors, path);
      }
    },
    ...
    notifyCursors: function() {
      var cursor, cursors, guid, path, _results;
      cursors = {};
      for (path in Tower.cursorsToUpdate) {
        cursor = Tower.getCursor(path);
        if (cursor) {
    ...
    stringify: function() {
      ...
      switch (Tower["case"]) {
        case "snakecase":
          return Tower.SupportString.underscore(string);
        default:
          return Tower.SupportString.camelize(string);
      }
    },
    namespace: function() {
  ...
  (function() {
    ...
    inflections = {
      ...
      camelCase: function(value) {
        return Tower.SupportString.camelize(value);
      }
    };
    asyncing = {
      series: function() {
  ...
  */
  ...
  Tower.Store = (function(_super) {
    ...
    __defineProperty(Store,  "serializeModel", function(attributes, saved) {
      var klass, model;
    ...
    __defineProperty(Store,  "init", function(options) {
      ...
      return this.className = options.type || Tower.namespaced(Tower.SupportString.camelize(Tower.SupportString.singularize(this.name)));
    });
    ...
    __defineProperty(Store,  "refresh", function() {});

    __defineProperty(Store,  "fetch", function(cursor, callback) {
  ...
  Tower.StoreBatch = (function(_super) {
    ...
    __defineProperty(StoreBatch,  "autocommit", Tower.isServer);

    __defineProperty(StoreBatch,  "bulk", false);

    __defineProperty(StoreBatch,  "init", function() {
      this._super.apply(this, arguments);
    ...
    __defineProperty(StoreBatch,  "removeCleanRecords", function() {
      var clean,
        _this = this;
    ...
    __defineProperty(StoreBatch,  "add", function(record) {
      return this.adopt(record);
    });

    __defineProperty(StoreBatch,  "remove", function(record) {
    ...
    __defineProperty(StoreBatch,  "adopt", function(record) {
      var oldTransaction;
    ...
    __defineProperty(StoreBatch,  "addToBucket", function(kind, record) {
    ...
    __defineProperty(StoreBatch,  "removeFromBucket", function(kind, record) {
      var bucket, records, type;
    ...
    __defineProperty(StoreBatch,  "getBucket", function(kind) {
      return Ember.get(Ember.get(this, 'buckets'), kind);
    });

    __defineProperty(StoreBatch,  "getType", function(recordOrCursor) {
    ...
    __defineProperty(StoreBatch,  "recordBecameClean", function(kind, record) {
      var defaultTransaction;
    ...
    __defineProperty(StoreBatch,  "recordBecameDirty", function(kind, record) {
      this.removeFromBucket('clean', record);
      return this.addToBucket(kind, record);
    });

    __defineProperty(StoreBatch,  "commit", function(callback) {
  ...
  Tower.StoreMemory = (function(_super) {
    ...
    __defineStaticProperty(StoreMemory,  "stores", function() {
      return this._stores || (this._stores = []);
    });

    __defineStaticProperty(StoreMemory,  "clean", function(callback) {
    ...
    __defineProperty(StoreMemory,  "init", function(options) {
      this._super.apply(this, arguments);
      return this.initialize();
    });

    __defineProperty(StoreMemory,  "initialize", function() {
    ...
    __defineProperty(StoreMemory,  "clean", function() {
      return this.records = Ember.Map.create();
    });

    __defineProperty(StoreMemory,  "commit", function() {
  ...
  Tower.StoreMemoryFinders = {
    find: function(cursor, callback) {
      var conditions, endIndex, limit, options, record, records, result, sort, startIndex, usingGeo, _i, _j, _len, _len1;
      result = [];
      ...
      sort = usingGeo ? this._getGeoSortCriteria() : options.get('order');
    ...
    _calculateDistances: function(records, nearCoordinate) {
      ...
      for (_i = 0, _len = records.length; _i < _len; _i++) {
        ...
        _results.push(record.__distance = Tower.SupportGeo.getDistance(center, coordinates));
      }
      return _results;
    },
  ...
  if (Tower.isClient) {
    Tower.StoreMemoryFinders.fetch = function(cursor, callback) {
      var method,
        _this = this;
      method = cursor.get('limit') === 1 ? 'findOne' : 'find';
  ...
  Tower.StoreTransaction = (function(_super) {
    ...
    __defineProperty(StoreTransaction,  "init", function() {
      return this.records = [];
    });

    __defineProperty(StoreTransaction,  "add", function(record) {
      return this.records.push(record);
    });

    __defineProperty(StoreTransaction,  "remove", function(record) {
      return this.records.splice(1, _.indexOf(this.records, record));
    });

    __defineProperty(StoreTransaction,  "adopt", function(record) {
      var transaction;
    ...
    __defineProperty(StoreTransaction,  "committed", function() {
    ...
    __defineProperty(StoreTransaction,  "rollback", function() {
      var record, records, _i, _len, _results;
      records = this.records;
      _results = [];
      for (_i = 0, _len = records.length; _i < _len; _i++) {
  ...
  Tower.Model = (function(_super) {
    ...
    __defineProperty(Model,  "readOnly", false);

    __defineProperty(Model,  "previousChanges", void 0);

    __defineProperty(Model,  "initialize", function(attributes, options) {
      if (attributes == null) {
        attributes = {};
      }
      if (options == null) {
  ...
  Tower.ModelMassAssignment = {
    ...
    _processRemovedAttributes: function(keys) {
      if (Tower.env !== 'test') {
        return console.warn("Can't mass-assign protected attributes: " + (keys.join(', ')));
      }
    }
  };
  ...
  Tower.ModelCursor = (function(_super) {
    ...
    __defineProperty(ModelCursor,  "isCursor", true);

    __defineStaticProperty(ModelCursor,  "make", function() {
      var cursor;
      cursor = this.create();
    ...
    __defineProperty(ModelCursor,  "init", function(attr) {
      if (attr == null) {
        attr = {};
      }
      if (Tower.isClient) {
        attr.content || (attr.content = Ember.A([]));
      }
    ...
    find: function(callback) {
      ...
      return this._runBeforeFindCallbacksOnStore(function() {
        return _this._find(function(error, records) {
          ...
          return _this._runAfterFindCallbacksOnStore(done, _.castArray(records));
        });
      });
    },
    ...
    _destroy: function(callback) {
      ...
      if (this.instantiate) {
        ...
        this.store.destroy(this, function(error, records) {
          if (!error) {
            Tower.notifyConnections('destroy', records);
          }
          if (callback) {
            return callback.call(_this, error, records);
          }
  ...
  Tower.ModelRelation = (function(_super) {
    ...
    __defineProperty(ModelRelation,  "isCollection", false);

    __defineProperty(ModelRelation,  "init", function(owner, name, options) {
      var value;
      if (options == null) {
        options = {};
      }
    ...
    __defineProperty(ModelRelation,  "initialize", function(options) {
    ...
    __defineProperty(ModelRelation,  "_defineRelation", function(name) {
    ...
    __defineProperty(ModelRelation,  "scoped", function(record) {
    ...
    __defineProperty(ModelRelation,  "targetKlass", function() {
      return Tower.constant(this.targetType);
    });

    __defineProperty(ModelRelation,  "klass", function() {
      return Tower.constant(this.type);
    });

    __defineProperty(ModelRelation,  "inverse", function(type) {
    ...
    __defineProperty(ModelRelation,  "_setForeignKey", function() {});

    __defineProperty(ModelRelation,  "_setForeignType", function() {});
  ...
  Tower.ModelRelationCursor = (function(_super) {
    ...
    __defineStaticProperty(ModelRelationCursor,  "makeOld", function() {
      var array;
      array = [];
      array.isCursor = true;
  ...
  Tower.ModelRelationBelongsTo = (function(_super) {
    ...
    __defineProperty(ModelRelationBelongsTo,  "isBelongsTo", true);

    __defineProperty(ModelRelationBelongsTo,  "init", function(owner, name, options) {
      var computed, mixins;
      if (options == null) {
        options = {};
      }
  ...
  Tower.ModelRelationBelongsToCursor = (function(_super) {
    ...
    __defineStaticProperty(ModelRelationBelongsToCursor,  "makeOld", function() {
      var array;
      array = [];
      array.isCursor = true;
  ...
  Tower.ModelRelationHasMany = (function(_super) {
    ...
    __defineProperty(ModelRelationHasMany,  "isHasMany", true);

    __defineProperty(ModelRelationHasMany,  "isCollection", true);
  ...
  Tower.ModelRelationHasManyCursor = (function(_super) {
    ...
    __defineStaticProperty(ModelRelationHasManyCursor,  "makeOld", function() {
      var array;
      array = [];
      array.isCursor = true;
      Tower.ModelRelationCursorMixin.apply(array);
  ...
  Tower.ModelRelationHasManyThrough = (function(_super) {
    ...
    __defineProperty(ModelRelationHasManyThrough,  "isHasManyThrough", true);

    __defineProperty(ModelRelationHasManyThrough,  "init", function(options) {
      var throughRelation;
      this._super.apply(this, arguments);
    ...
    __defineProperty(ModelRelationHasManyThrough,  "inverseThrough", function(relation) {
  ...
  Tower.ModelRelationHasManyThroughCursor = (function(_super) {
    ...
    __defineStaticProperty(ModelRelationHasManyThroughCursor,  "makeOld", function() {
      var array;
      array = [];
      array.isCursor = true;
      Tower.ModelRelationCursorMixin.apply(array);
  ...
  Tower.ModelRelationHasOne = (function(_super) {
    ...
    __defineProperty(ModelRelationHasOne,  "isHasOne", true);
  ...
  Tower.ModelRelationHasOneCursor = (function(_super) {
    ...
    __defineStaticProperty(ModelRelationHasOneCursor,  "makeOld", function() {
      var array;
      array = [];
      array.isCursor = true;
      Tower.ModelRelationCursorMixin.apply(array);
  ...
  Tower.ModelSerialization = {
    ...
    _serializableHash: function(options) {
      var attributeNames, cid, except, i, include, includes, methodNames, methods, name, only, opts, record, records, result, tmp, _len6, _len7, _len8, _len9, _o, _p, _q, _r;
      if (options == null) {
        options = {};
      }
      result = {};
  ...
  */
  ...
  Tower.View = (function(_super) {
    ...
    View.reopenClass({
      ...
      renderers: {},
      coffeecupTags: Tower.isServer ? _.map(Tower.modules.coffeecup.tags, function(i) {
        return Tower.SupportString.camelize(i, true);
      }) : [],
  ...
  Tower.ViewAssetHelper = {
    ...
    _extractAssetPaths: function(sources, options) {
      var assets, extension, manifest, namespace, path, paths, result, source, _len6, _len7, _len8, _o, _p, _q;
      if (options == null) {
        options = {};
      }
  ...
  Tower.View.reopen({
    ...
    findEmberView: function(options) {
      if (options.view) {
        ...
        return App.get(Tower._.camelize(options.template) + 'View');
      }
    },
  ...
  Tower.Controller = (function(_super) {
    ...
    __defineProperty(Controller,  "init", function() {
      ...
      this.formats = Tower.isClient ? ['html'] : Tower._.keys(metadata.mimes);
  ...
  Tower.ControllerInstrumentation = {
    InstanceMethods: {
      call: function(request, response, next) {
        var accept, acceptFormat, files, params, value, _ref6, _ref7;
  ...
  Tower.ControllerMetadata = {
    ClassMethods: {
      ...
      _compileResourceName: function(type) {
        ...
        parts = type.split('.');
        return resourceName = Tower._.camelize(parts[parts.length - 1], true);
      }
    }
  };
  ...
  Tower.ControllerParams = {
    ...
    InstanceMethods: {
      ...
      _buildCursorFromGet: function(cursor) {
        var name, object, params, parser, parsers;
        parsers = this.constructor.params();
        params = this.params;
        for (name in parsers) {
          parser = parsers[name];
  ...
  Tower.ControllerResourceful = {
    ClassMethods: {
      ...
      belongsTo: function(key, options) {
        ...
        options || (options = {});
        options.key = key;
        options.type || (options.type = Tower._.camelize(options.key));
  ...
  Tower.ControllerResponding = {
    ClassMethods: {
      respondTo: function() {
        ...
        if (options.only) {
          only = Tower._.toArray(options.only);
        }
        if (options.except) {
          except = Tower._.toArray(options.except);
        }
        for (_o = 0, _len6 = args.length; _o < _len6; _o++) {
          name = args[_o];
          mimes[name] = {};
    ...
    ClassMethods: {
      scope: function(name, scope) {
        ...
        try {
          ...
          if (Tower._.indexOf(metadata.scopeNames, name) === -1) {
  ...
  Tower.Controller.reopenClass({
    ...
    instance: function() {
      return Tower.Application.instance().get(Tower._.camelize(this.className(), true));
    }
  });
  ...
  Tower.NetParamNumber = (function(_super) {
    ...
    function NetParamNumber() {
      return NetParamNumber.__super__.constructor.apply(this, arguments);
    }
  ...
  Tower.NetParamString = (function(_super) {
    ...
    function NetParamString() {
      return NetParamString.__super__.constructor.apply(this, arguments);
    }
  ...
  Tower.NetRoute = (function(_super) {
    ...
    __defineStaticProperty(NetRoute,  "store", function() {
      return this._store || (this._store = []);
    });

    __defineStaticProperty(NetRoute,  "byName", {});

    __defineStaticProperty(NetRoute,  "create", function(route) {
      this.byName[route.name] = route;
      return this.store().push(route);
    });

    __defineStaticProperty(NetRoute,  "find", function(name) {
      return this.byName[name];
    });

    __defineStaticProperty(NetRoute,  "findByUrl", function(url) {
    ...
    __defineStaticProperty(NetRoute,  "findByControllerOptions", function(options) {
    ...
    __defineStaticProperty(NetRoute,  "all", function() {
      return this.store();
    });

    __defineStaticProperty(NetRoute,  "clear", function() {
      return this._store = [];
    });

    __defineStaticProperty(NetRoute,  "reload", function() {
      this.clear();
      return this.draw();
    });

    __defineStaticProperty(NetRoute,  "draw", function(callback) {
    ...
    __defineStaticProperty(NetRoute,  "findController", function(request, response, callback) {
    ...
    __defineProperty(NetRoute,  "toControllerData", function(url, params) {
    ...
    __defineProperty(NetRoute,  "toController", function(request) {
    ...
    __defineProperty(NetRoute,  "init", function(options) {
    ...
    __defineProperty(NetRoute,  "get", function(name) {
      return this[name];
    });

    __defineProperty(NetRoute,  "match", function(requestOrPath) {
      var match, path;
    ...
    __defineProperty(NetRoute,  "matchConstraints", function(request) {
    ...
    __defineProperty(NetRoute,  "urlFor", function(options) {
      var result, value;
      if (options == null) {
        options = {};
      }
    ...
    __defineProperty(NetRoute,  "extractPattern", function(path, caseSensitive, strict) {
      var self;
  ...
  Tower.NetConnection = (function(_super) {
    ...
    __defineStaticProperty(NetConnection,  "transport", void 0);

    __defineStaticProperty(NetConnection,  "controllers", []);

    __defineStaticProperty(NetConnection,  "handlers", Ember.Map.create());

    __defineStaticProperty(NetConnection,  "initialize", function() {
    ...
    __defineStaticProperty(NetConnection,  "addHandler", function(name, handler) {
      return this.handlers.set(name, handler);
    });

    __defineProperty(NetConnection,  "registerHandlers", function() {
      var _this = this;
    ...
    __defineProperty(NetConnection,  "resolve", function(action, records, callback) {
    ...
    __defineProperty(NetConnection,  "notifyTransport", function(action, records) {
      if (this.constructor.transport != null) {
        return this.constructor.transport[action](records, callback);
      }
    });

    __defineProperty(NetConnection,  "destroy", function(callback) {
      return callback();
    });

    __defineProperty(NetConnection,  "on", function(eventType, handler) {
  ...
  Tower.NetConnection = (function(_super) {
    ...
    __defineStaticProperty(NetConnection,  "connect", function(socket, callback) {
      var _this = this;
    ...
    __defineStaticProperty(NetConnection,  "disconnect", function() {
      var _this = this;
      if (!Tower.connection) {
        return;
      }
    ...
    __defineProperty(NetConnection,  "connect", function() {
      var _this = this;
      this.on('sync', function(data) {
        if (!Tower.NetConnection.transport.requesting) {
    ...
    __defineProperty(NetConnection,  "notify", function(action, records, callback) {
      records = _.castArray(records);
    ...
    __defineProperty(NetConnection,  "clientDidChange", function(action, records, callback) {
      var _this = this;
    ...
    __defineProperty(NetConnection,  "serverDidChange", function(data) {
      return this["serverDid" + (_.camelize(data.action))](data);
    });

    __defineProperty(NetConnection,  "serverDidCreate", function(data) {
      try {
        return Tower.constant(data.type).load(data.records);
      } catch (_error) {}
    });

    __defineProperty(NetConnection,  "serverDidUpdate", function(data) {
      try {
        return Tower.constant(data.type).load(data.records);
      } catch (_error) {}
    });

    __defineProperty(NetConnection,  "serverDidDestroy", function(data) {
      try {
        return Tower.constant(data.type).unload(data.records);
      } catch (_error) {}
    });

    __defineProperty(NetConnection,  "clientDidLoad", function(records) {
      return this.resolve('create', records);
    });

    __defineProperty(NetConnection,  "clientDidCreate", function(records, callback) {
      return this.notifyTransport('create', records, callback);
    });

    __defineProperty(NetConnection,  "clientDidUpdate", function(records) {
      return this.notifyTransport('update', records);
    });

    __defineProperty(NetConnection,  "clientDidDestroy", function(records) {
      return this.notifyTransport('destroy', records);
    });

    __defineProperty(NetConnection,  "notifyTransport", function(action, records, callback) {
      if (this.constructor.transport != null) {
        return this.constructor.transport[action](records, callback);
      }
    });
  ...
  Tower.NetConnectionSocketio = {
    ...
    listen: function(url) {
      return this.connect(Tower.modules.socketio.connect(url));
    },
  ...
  Tower.NetConnectionSockjs = {
    ...
    listen: function(url) {
      return this.connect(new Tower.modules.sockjs(url));
    },
  ...
  Tower.Router = Ember.Router.extend({
    ...
    insertRoute: function(route) {
      var controllerName, i, methodName, n, path, r, routeName, s, state, states;
      if (route.state) {
        path = route.state;
      } else {
        path = [];
      ...
      while (i < n) {
        ...
        if (s) {
          ...
          s = this.createControllerActionState(controllerName, r[i], routeName);
  ...
  Tower.goTo = function(string, params) {
    return History.pushState(params, params != null ? params.title : void 0, string);
  };
